...
import logging
import numpy as np
from cyberbattle._env import shared_cyberbattle_env as cyberbattle_env
...
def epsilon_greedy_search(
    cyberbattle_gym_env: cyberbattle_env.CyberBattleEnvTest,
...
def transfer_learning_evaluation(
    ...
    eval_env: cyberbattle_env.CyberBattleEnvTest,
    eval_epsilon: float,
